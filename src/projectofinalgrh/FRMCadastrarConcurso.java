...
public class FRMCadastrarConcurso extends JFrame implements ActionListener {
    ...
    public FRMCadastrarConcurso() throws IOException, FileNotFoundException, ClassNotFoundException{
       ...
       lblTexto=new JLabel("CADASTRAR CONCURSO"); lblTexto.setFont(fonte1); lblTexto.setForeground(Color.white); lblTexto.setBounds(210, 2,400, 30);  add(lblTexto);
       ...
       cboDepartamento.addActionListener(this);
        btnSalvar=new JButton("Salvar"); btnSalvar.setBounds(150, 250, 120, 50); btnSalvar.setFont(fonte); btnSalvar.setForeground(Color.white);btnSalvar.setBackground(Color.darkGray); add(btnSalvar);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==btnSalvar){
           ...
           String depaNome=cboDepartamento.getSelectedItem().toString();
           
                 try {
                 Concurso concu=new Concurso(codigo, depaNome, quantidade);
                 ControllerConcurso.escreverConcurso(concu);
                 
                } catch (IOException ex) {
                    Logger.getLogger(FRMCadastrarConcurso.class.getName()).log(Level.SEVERE, null, ex);
